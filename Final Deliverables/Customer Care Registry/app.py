...
conn = ibm_db.connect("DATABASE=BLUDB;HOSTNAME=3883e7e4-18f5-4afe-be8c-fa31c41761d2.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=31498;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;PROTOCOL=TCPIP;UID=wcg14700;PWD=Srv4mumhxc8dxJ6J;","","")
...
@app.route('/')
def home():
    message = "TEAM ID : PNT2022TMID11566" +" "+ "BATCH ID : B10-4A6E "
...
def verifyemail():
    try:
        ...
        sender = {"name": "IBM CUSTOMER CARE REGISTRY",
                  "email": "unknownit@gmail.com"}
        to = [{"email": email, "name": name}]
        reply_to = {"email": "unknownit@gmail.com", "name": "IBM"}
        headers = {"Some-Custom-Name": "unique-id-1234"}
        params = {"parameter": "My param value",
                  "subject": "Email Verification"}
        send_smtp_email = sib_api_v3_sdk.SendSmtpEmail(
